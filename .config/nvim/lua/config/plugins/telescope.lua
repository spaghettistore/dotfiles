return {
    {
        ...
        -- Version 0.12: commented out tag
        --tag = '0.1.8',
        ...
        config = function()
            ...
            vim.keymap.set("n", "<leader>:", require('telescope.builtin').command_history, {desc = ":Telescope command_history"})
            ...
            vim.keymap.set("n", "<leader>sc", require('telescope.builtin').quickfix, {desc = ":Telescope quickfix"})
            ...
            vim.keymap.set("n", "<leader>s'", require('telescope.builtin').marks, {desc = ":Telescope marks"})
